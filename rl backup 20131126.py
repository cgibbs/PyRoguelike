...
class Object:
    def __init__(self, x, y, char, name, color, hunger_dec=1, hunger=100, blocks=False,
                 always_visible=False, fighter=None, ai=None, equipment=None, item=None, inv=None):
        self.x = x
        self.y = y
        self.char = char
        self.color = color
...
def create_monster(x, y):
    ...
    if choice == 'orc':
        fighter_component = Fighter(hp=15, defense=0, power=1, xp=15, attack_dice=(1,4),
        ...
        ai_component = BasicMonster()
        monster = Object(x, y, 'L', 'Lich', libtcod.darker_green,
                         blocks=True, fighter=fighter_component,
                         ai=ai_component)
    elif choice == 'dragon':
